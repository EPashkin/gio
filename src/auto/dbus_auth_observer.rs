    ...
    pub fn connect_allow_mechanism<F: Fn(&DBusAuthObserver, &str) -> bool + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(allow_mechanism_trampoline::<F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    >(
        ...
        >(
            ...
            f(
                ...
                Option::<Credentials>::from_glib_borrow(credentials).as_ref(),
            )
            .to_glib()
        }
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    authorize_authenticated_peer_trampoline::<F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
