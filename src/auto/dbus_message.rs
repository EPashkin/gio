...
impl DBusMessage {
    ...
    //pub fn get_unix_fd_list(&self) -> /*Ignored*/Option<UnixFDList> {
    //    unsafe { TODO: call gio_sys:g_dbus_message_get_unix_fd_list() }
    //}
    ...
    //pub fn set_unix_fd_list(&self, fd_list: /*Ignored*/Option<&UnixFDList>) {
    //    unsafe { TODO: call gio_sys:g_dbus_message_set_unix_fd_list() }
    //}
    ...
    pub fn connect_property_locked_notify<F: Fn(&DBusMessage) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_locked_trampoline::<F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
